...
PIXEL_OPERATORS = [
    {
        "func": aug.random_cutout,
        "option": {"num_holes": 8, "hole_size": 20, "replace": 0},
    },
...
def apply_one(image, functions=OPERATORS, prob=1.0):
    ...
    return tf.cond(
        ...
        lambda: _apply_one(image, functions=functions),
        lambda: image,
    )
