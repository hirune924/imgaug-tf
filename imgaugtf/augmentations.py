...
def random_zoom(image, scale=0.2, interpolation: str = "nearest", fill_mode="constant", fill_value=0, prob=0.5):
    return apply_func_with_prob(F.zoom, image, (scale, interpolation, fill_mode, fill_value), prob)
